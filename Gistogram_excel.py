#Считывает информацию в эксель-файле и добавляет в датафрэйм. 
#В отдельный датафрэйм добавляет 5 самых крупных показателей из столбца "Стандартное отклонение". 
#Рисует график стандартного отклонения при учете условий.
